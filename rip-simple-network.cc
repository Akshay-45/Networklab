...
//  listRH.Add (staticRh, 5);
  ...
  Simulator::Schedule (Seconds (40), &TearDownLink, b, d, 3, 2);
    ...
    anim.SetConstantPosition(nodes.Get(0),20.0,120.0);//Src
    anim.SetConstantPosition(nodes.Get(1),50.0,00.0);//Dest

    anim.SetConstantPosition(routers.Get(1),25.0,100.0);//A
    anim.SetConstantPosition(routers.Get(2),75.0,100.0);//B
    anim.SetConstantPosition(routers.Get(3),50.0,50.0);//C
